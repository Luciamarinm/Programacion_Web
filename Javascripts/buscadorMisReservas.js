document.addEventListener('DOMContentLoaded', function () {
    const input = document.getElementById('buscadorMisReservas'); //Recoge el contenido del input
    const tabla = document.getElementById('tablaMisReservas'); //Recoge el contenido de la tabla
    if (input && tabla) {
