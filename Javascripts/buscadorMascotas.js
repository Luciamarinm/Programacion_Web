document.addEventListener('DOMContentLoaded', function () {
    const input = document.getElementById('buscadorMascotas'); //Recoge el contenido del input
    const tabla = document.getElementById('tablaMascotas'); //Recoge el contenido de la tabla
    if (input && tabla) {
