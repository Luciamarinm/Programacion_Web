document.addEventListener('DOMContentLoaded', function () {
    const input = document.getElementById('buscadorReservas'); //Recoge el contenido del input
    const tabla = document.getElementById('tablaReservas'); //Recoge el contenido de la tabla
    if (input && tabla) {
