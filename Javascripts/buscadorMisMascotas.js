document.addEventListener('DOMContentLoaded', function () {
    const input = document.getElementById('buscadorMisMascotas'); //Recoge el contenido del input
    const tabla = document.getElementById('tablaMisMascotas'); //Recoge el contenido de la tabla
    if (input && tabla) {
